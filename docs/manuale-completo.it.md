...
**Versione del software: 2.0** · Repository: **https://github.com/kWGillo/zedmd-pi**
...
| `clock.offset_v` | `2` | spostamento verticale dell'ora, ±12 px |
| `clock.colore_casuale` | `false` | un colore diverso per le cifre a ogni ora |
...
**Giochi** — Breakout, Invaders, Snake, Pongo, Squadriglia, Gnam Gnam e Mine vaganti, i comandi di tastiera e pad, e la
...
Le **partite** — Doom, Game Boy, Breakout, Invaders, Snake, Pongo, Squadriglia, Gnam Gnam e Mine vaganti — non partecipano a
